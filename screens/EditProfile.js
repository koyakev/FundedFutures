...
import { collection, updateDoc, getDocs, query, doc, where, getDoc } from 'firebase/firestore';
...
export default function EditProfile({ navigation, route }) {
    ...
    const updateStudent = async () => {
        ...
        if (firstname == '' || lastname == '' || school == '' || contact == '' || program == '' || studentId == '' || username == '' || gender == '' || password == '' || image == null) {
